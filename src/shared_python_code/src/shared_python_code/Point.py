...
LOCATIONS = {'door':CPoint(-8.18,-3.16,0.0), 'drumside': CPoint(-4.07,-7.24,0.0),
             ...
             'IP1':CPoint(  -2.1981678009033203, -4.938733100891113, 0.0),
             'IP2':CPoint( -5.969668388366699, 3.861062526702881, 0.0),
             'farwall':CPoint( 7.745523452758789,3.8347959518432617,0.0),
             'IP3':CPoint(1.8702278137207031,-0.5160531997680664,0.0)
             }
