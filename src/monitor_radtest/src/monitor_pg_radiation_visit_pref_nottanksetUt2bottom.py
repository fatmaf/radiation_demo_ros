...
from monitor_radtest.msg import *
...
def monitor():
	...
	with open(log, 'w') as log_file:
		log_file.write('')
	rospy.init_node('monitor_pg_radiation_visit_pref_nottanksetUt2bottom', anonymous=True)
	pub_error = rospy.Publisher(name = 'monitor_pg_radiation_visit_pref_nottanksetUt2bottom/monitor_error', data_class = MonitorError, latch = True, queue_size = 1000)
	pub_verdict = rospy.Publisher(name = 'monitor_pg_radiation_visit_pref_nottanksetUt2bottom/monitor_verdict', data_class = String, latch = True, queue_size = 1000)
...
def main(argv):
	...
	log = '/home/fatma/work/code/ros/ros1/rad_ws/monitor_pg_radiation_visit_pref_nottanksetUt2bottom.txt' 
	actions = {
