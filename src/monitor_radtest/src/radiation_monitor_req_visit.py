...
def monitor():
	...
	with open(log, 'w') as log_file:
		log_file.write('')
	rospy.init_node('radiation_monitor_req_visit', anonymous=True)
	pub_error = rospy.Publisher(name = 'radiation_monitor_req_visit/monitor_error', data_class = MonitorError, latch = True, queue_size = 1000)
	pub_verdict = rospy.Publisher(name = 'radiation_monitor_req_visit/monitor_verdict', data_class = String, latch = True, queue_size = 1000)
...
def main(argv):
	...
	log = '/home/fatma/work/code/ros/ros1/rad_ws/monitor_resources_visit_req_log.txt' 
	#log = '/home/robotlab/code/ros/radiation_demo_ros/monitor_resources_visit_req_log.txt' 
	actions = {
